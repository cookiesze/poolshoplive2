...
<head>
    <meta charset="UTF-8">
    <title>Plantein Complex Powder</title>
...
<div class="col-md-12">
    <div class="title-s2 text-center">
        ...
        <img src="{{ asset('assets/onsite/biopool/preif/biopool3-01.jpg') }}">
        <img src="{{ asset('assets/onsite/biopool/preif/biopool3-02.jpg') }}">
        <img src="{{ asset('assets/onsite/biopool/preif/biopool3-03.jpg') }}">
        <img src="{{ asset('assets/onsite/biopool/preif/biopool3-04.jpg') }}">
