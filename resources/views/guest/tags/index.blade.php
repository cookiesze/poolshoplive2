            ...
            <div class="col-xl-12">
                <div class="inner-content-box clearfix">
                    <div class="title-s2 text-center">
                        <span>ผลการค้าหา</span>
                        <h1 style="font-weight: 500;">"{{ $tag->name }}" Tags</h1>
                        <h4 style="padding-bottom: 3em; color:aliceblue; font-weight: 200;" >พบข่าวมี {{ $tag->name }} Tags จำนวน {{ $tag->posts()->count() }} ข่าว</h4>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="sidebar-wrapper">
                    ...
                    <div class="single-sidebar categories-box">
                        <div class="sidebar-title">
                            <div class="title">Categories Products</div>
                        </div>
                        <ul class="categories clearfix">
                            @foreach ( $category as $items)
                            <li><a href="#"><sup></sup>{{$items->name }}</a></li>
                            @endforeach
                    ...
                    <div class="single-sidebar tag-box clerfix">
                        ...
                        <ul class="popular-tag clearfix">
                            ...
                            <li><a class="tag" href="{{ url('guest/tags',['tag' => $tag->name]) }}">{{ $tag->name }}</a></li>
                            @endforeach
                        </ul>
                    </div>
                    <!--End single-sidebar-->
