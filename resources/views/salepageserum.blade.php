...
<head>
    <meta charset="UTF-8">
    <title>24 Plus White Protect Serum</title>
...
<div class="col-md-12">
    <div class="title-s2 text-center">
        ...
        <img src="{{ asset('assets/onsite/24plus/serum/24PLUS2-01.jpg') }}">
        <img src="{{ asset('assets/onsite/24plus/serum/24PLUS2-02.jpg') }}">
        <img src="{{ asset('assets/onsite/24plus/serum/24PLUS2-03.jpg') }}">
        <img src="{{ asset('assets/onsite/24plus/serum/24PLUS2-04.jpg') }}">
