...
<head>
    <meta charset="UTF-8">
    <title>Heokkaetione Complex</title>
...
<div class="col-md-12">
    <div class="title-s2 text-center">
        ...
        <img src="{{ asset('assets/onsite/biopool/heokkaetione/biopool-02.jpg') }}">
        <img src="{{ asset('assets/onsite/biopool/heokkaetione/biopool-03.jpg') }}">
        <img src="{{ asset('assets/onsite/biopool/heokkaetione/biopool-04.jpg') }}">
