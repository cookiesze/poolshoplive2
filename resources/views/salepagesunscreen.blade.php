...
<head>
    <meta charset="UTF-8">
    <title>24 Plus Sunscreen PA+++</title>
...
<div class="col-md-12">
    <div class="title-s2 text-center">
        ...
        <img src="{{ asset('assets/onsite/24plus/sunscreen/24PLUS3-02.jpg') }}">
        <img src="{{ asset('assets/onsite/24plus/sunscreen/24PLUS3-03.jpg') }}">
        <img src="{{ asset('assets/onsite/24plus/sunscreen/24PLUS3-04.jpg') }}">
