...
<head>
    <meta charset="UTF-8">
    <title>CANN LAB INTENSIVE NATURAL HAIR SHAMPOO</title>
...
<div class="col-md-12">
    <div class="title-s2 text-center">
        ...
        <img src="{{ asset('assets/onsite/cannlab/shampoo/Cannlab2-01.png') }}">
        <img src="{{ asset('assets/onsite/cannlab/shampoo/Cannlab2-02.png') }}">
        <img src="{{ asset('assets/onsite/cannlab/shampoo/Cannlab2-03.png') }}">
        <img src="{{ asset('assets/onsite/cannlab/shampoo/Cannlab2-04.png') }}">
        <img src="{{ asset('assets/onsite/cannlab/shampoo/Cannlab2-05.png') }}">
