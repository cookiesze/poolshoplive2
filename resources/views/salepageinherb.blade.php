...
<div class="col-md-12">
    <div class="title-s2 text-center">
        <img src="{{ asset('assets/onsite/inherb/inherb-08.png') }}">
        <img src="{{ asset('assets/onsite/inherb/inherb-09.png') }}">
        <img src="{{ asset('assets/onsite/inherb/inherb-10.png') }}">
        <img src="{{ asset('assets/onsite/inherb/inherb-01.png') }}">
        <img src="{{ asset('assets/onsite/inherb/inherb-02.png') }}">
        <img src="{{ asset('assets/onsite/inherb/inherb-03.png') }}">
        <img src="{{ asset('assets/onsite/inherb/inherb-04.png') }}">
        <img src="{{ asset('assets/onsite/inherb/inherb-05.png') }}">
        <img src="{{ asset('assets/onsite/inherb/inherb-06.png') }}">
        <img src="{{ asset('assets/onsite/inherb/inherb-07.png') }}">
