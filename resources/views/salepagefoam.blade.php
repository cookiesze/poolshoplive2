...
<head>
    <meta charset="UTF-8">
    <title>24 Plus Facail Wash</title>
...
<div class="col-md-12">
    <div class="title-s2 text-center">
        ...
        <img src="{{ asset('assets/onsite/24plus/24PLUS-00.png') }}">
        <img src="{{ asset('assets/onsite/24plus/24PLUS-01.jpg') }}">
        <img src="{{ asset('assets/onsite/24plus/24PLUS-02.jpg') }}">
        <img src="{{ asset('assets/onsite/24plus/24PLUS-03.jpg') }}">
        <img src="{{ asset('assets/onsite/24plus/24PLUS-04.jpg') }}">
        <img src="{{ asset('assets/onsite/24plus/24PLUS-05.jpg') }}">
