...
<head>
    <meta charset="UTF-8">
    <title>CANN LAB NATURAL CLEANSING SHOWER GEL</title>
...
<div class="col-md-12">
    <div class="title-s2 text-center">
        ...
        <img src="{{ asset('assets/onsite/cannlab/shower/Cannlab-02.png') }}">
        <img src="{{ asset('assets/onsite/cannlab/shower/Cannlab-03.png') }}">
        <img src="{{ asset('assets/onsite/cannlab/shower/Cannlab-04.png') }}">
        <img src="{{ asset('assets/onsite/cannlab/shower/Cannlab-05.png') }}">
        <img src="{{ asset('assets/onsite/cannlab/shower/Cannlab-06.png') }}">
        <img src="{{ asset('assets/onsite/cannlab/shower/Cannlab-07.png') }}">
